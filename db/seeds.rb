...
killer = Killer.new(name: "The Tyrant", alias: 'Nemesis', bio: 'The Nemesis is a Model T-103 Tyrant', location: 'Raccoon City', price: 2000, user_id: 1)
killer.photo.attach(io: file, filename: 'freddy.jpeg', content_type: 'image/png')
killer.save!
