...
nemesis = Killer.create([{ name: "Nemesis T-Type"}, { alias: "The Tyrant" }, { bio: "The Nemesis is a Model T-103 Tyrant, a superhuman bio-organic weapon mass-produced by Umbrella Corporation.
Unlike previous prototypes, it possessed near-human intelligence and could follow orders.
It was flown into Raccoon City alongside other Tyrants and ordered to eliminate any remaining members of S.T.A.R.S., including Jill Valentine."}, {location: "Raccoon City"}, {price: 2000}])
